...
import { removeJob, setOpen } from "../../redux/drawer";
...
const CustomDrawer = () => {
  const { job, isOpen } = useSelector((state) => state.drawer);
  ...
  return (
    <Drawer anchor="right" open={isOpen} onClose={closeDrawer}>
      <Box sx={{ maxWidth: "1000px", m: 20 }}>
        ...
        >
          <IconButton color="primary" onClick={() => dispatch(setOpen())}>
            <ArrowBackIosNewIcon />
          </IconButton>
          <Typography
            component={Link}
            sx={{ color: "primary.main", textDecoration: "none", display: 'flex', alignItems : 'center', gap: 2 }}
        ...
        >
          <Box sx={{ flex: 1, borderRight: "1px solid #ccc" }}>
            ...
            <Box
              ...
              justifyContent="space-between"
            >
              <Box display="flex" alignItems="flex-start" gap="10px" width={'220px'} justifyContent='flex-start'>
                <LocalOfferIcon />
                <Box>
              ...
              <Box display="flex" alignItems="flex-start" gap="10px" width={'220px'} justifyContent='center'>
                <PsychologyIcon />
                <Box>
                  <Typography variant="body1" fontWeight={600}>
              ...
              <Box display="flex" alignItems="flex-start" gap="10px" width={'220px'} justifyContent='flex-end'>
